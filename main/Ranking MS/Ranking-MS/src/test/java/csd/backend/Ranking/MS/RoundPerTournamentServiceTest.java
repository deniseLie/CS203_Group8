...
//         // Arrange
//         RoundPerTournament newRound = new RoundPerTournament(1L, 101L, 102L, true, 1, 100, 50, 30, 80);
...
//         assertThat(createdRound.getTournamentId()).isEqualTo(1L);
//         assertThat(createdRound.getFirstPlayerId()).isEqualTo(101L);
...
//         // Arrange
//         RoundPerTournament round1 = new RoundPerTournament(1L, 101L, 102L, true, 1, 100, 50, 30, 80);
//         RoundPerTournament round2 = new RoundPerTournament(2L, 103L, 104L, false, 2, 90, 40, 60, 70);
...
//         // Arrange
//         RoundPerTournamentId id = new RoundPerTournamentId(1L, 101L, 102L);
//         RoundPerTournament mockRound = new RoundPerTournament(1L, 101L, 102L, true, 1, 100, 50, 30, 80);
...
//         // Arrange
//         RoundPerTournamentId id = new RoundPerTournamentId(1L, 101L, 102L);
//         RoundPerTournament existingRound = new RoundPerTournament(1L, 101L, 102L, true, 1, 100, 50, 30, 80);
//         RoundPerTournament updatedRound = new RoundPerTournament(1L, 101L, 102L, false, 1, 90, 40, 60, 70);
