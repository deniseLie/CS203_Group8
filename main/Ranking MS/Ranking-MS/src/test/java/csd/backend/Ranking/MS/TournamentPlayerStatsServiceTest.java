...
// import csd.backend.Ranking.MS.TournamentPlayerStatsId;
...
//         // Arrange
//         TournamentPlayerStats newStats = new TournamentPlayerStats(1L, 1L, 2, 20, 101, 1, 3.5, 3600, 5000, 4500, 5);
...
//         assertThat(createdStats.getPlayerId()).isEqualTo(1L);
//         assertThat(createdStats.getTournamentId()).isEqualTo(1L);
...
//         // Arrange
//         TournamentPlayerStats stats1 = new TournamentPlayerStats(1L, 1L, 2, 20, 101, 1, 3.5, 3600, 5000, 4500, 5);
//         TournamentPlayerStats stats2 = new TournamentPlayerStats(2L, 1L, 3, 15, 102, 2, 2.8, 3700, 4800, 4600, 4);
...
//         // Arrange
//         TournamentPlayerStatsId id = new TournamentPlayerStatsId(1L, 1L);
//         TournamentPlayerStats mockStats = new TournamentPlayerStats(1L, 1L, 2, 20, 101, 1, 3.5, 3600, 5000, 4500, 5);
...
//         // Verify
//         verify(tournamentPlayerStatsRepository, times(1)).findById(id);
//     }
...
//         // Arrange
//         TournamentPlayerStatsId id = new TournamentPlayerStatsId(1L, 1L);
//         TournamentPlayerStats existingStats = new TournamentPlayerStats(1L, 1L, 2, 20, 101, 1, 3.5, 3600, 5000, 4500, 5);
//         TournamentPlayerStats updatedStats = new TournamentPlayerStats(1L, 1L, 2, 25, 101, 1, 3.8, 3700, 5100, 4600, 6);
